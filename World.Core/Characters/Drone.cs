...
namespace World.Core.Characters
{
    ...
    // over a ridge rather than going through it, and turns lazily to keep facing them.
    public sealed class Drone
    {
        ...
        public void Step(Vector3 feet, float ownerYaw, Vector3 lookAt, float dt, IGround ground)
        {
            ...
            var acceleration = (Station(feet, ownerYaw) - Position) * (Stiffness * Stiffness) - Velocity * (2f * Stiffness);
